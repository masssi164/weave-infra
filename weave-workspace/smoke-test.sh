...
assert_backend_nextcloud_actor_config() {
  ...
  [[ "${external_private_user_calendars}" == "disabled" ]] || fail "Smoke check failed: private personal CalDAV calendars must stay disabled until provisioning/sharing is tested"
