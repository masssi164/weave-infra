...
nextcloud_status="$(curl_json "$(public_url "${TF_VAR_nextcloud_subdomain:-files}")/status.php")"
...
nextcloud_oidc_redirect="$(curl_location "$(public_url "${TF_VAR_nextcloud_subdomain:-files}")/apps/user_oidc/login/1")"
